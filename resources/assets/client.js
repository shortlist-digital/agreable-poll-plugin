...
},{"is-nan":3}],2:[function(require,module,exports){
'use strict';
...
},{"./polyfill":8,"define-properties":4}],10:[function(require,module,exports){
...
},{"strict-uri-encode":12}],12:[function(require,module,exports){
'use strict';
...
var AnswerBar = React.createClass({
  ...
  _calculatePercentage: function _calculatePercentage() {
  ...
  _updateLoadState: function _updateLoadState() {
    this.setState({
      firstLoad: false
    });
  },
  ...
  _brandBackground: function _brandBackground() {
    var color = "";
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'senti-poll-progress', style: this._progressStyle },
        React.createElement(
          'div',
          { className: 'senti-poll-progress-bar', role: 'progressbar', 'aria-valuenow': '{p}', 'aria-valuemin': '0', 'aria-valuemax': '100', style: prefixr(barStyle) },
          React.createElement(
            'div',
            { className: 'senti-poll-progress-text', style: textStyle },
            p,
            '%'
          )
        ),
        React.createElement('div', { className: 'senti-poll-brand-bar', style: prefixr(brandStyle) })
      ),
      React.createElement(
        'span',
...
},{"react":186,"react-prefixr":13}],190:[function(require,module,exports){
'use strict';
...
var AnswerButton = React.createClass({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(newData) {
  ...
  _resetPlusOne: function _resetPlusOne() {
    this.setState({
      plusOneClass: 'no-fadeOutUp'
    });
  },

  _resetPulse: function _resetPulse() {
    this.setState({
      pulseClass: 'no-pulse'
    });
  },
  ...
  render: function render() {
    ...
    return React.createElement(
      'div',
      { className: 'senti-poll-button-wrapper' },
      React.createElement(
        'button',
        {
      ...
      React.createElement(
        'div',
        { name: this.props.index, className: this.state.plusOneClass },
        '+1'
      )
    );
  }
...
},{"query-string":11,"react":186}],191:[function(require,module,exports){
'use strict';
...
var Answers = React.createClass({
  ...
  _renderAnswers: function _renderAnswers() {
    if (this.props.answers) {
      var answerComponents = [];
      var answers = this.props.answers;
      answers.map(function (answer, index) {
        answerComponents.push(React.createElement(AnswerButton, _extends({
          key: index,
          index: index
        }, answer, {
...
},{"./AnswerButton.jsx":190,"react":186}],192:[function(require,module,exports){
'use strict';
...
var Results = React.createClass({
  ...
  _renderGraph: function _renderGraph() {
    ...
    answers.map(function (answer, index) {
      graphComponents.push(React.createElement(AnswerBar, _extends({ key: index }, answer, { entries: this.props.pollData.entries })));
    }, this);
...
},{"./AnswerBar.jsx":189,"react":186}],193:[function(require,module,exports){
'use strict';
...
var Sharing = React.createClass({
  ...
  _registerShare: function _registerShare() {
  ...
  _revealWrapper: function _revealWrapper() {
  ...
  render: function render() {
    return React.createElement(
      'div',
      { className: 'senti-poll-sharing-wrapper ' + this.state.wrapperClass },
      React.createElement('div', { className: 'senti-poll-bfc' }),
      React.createElement(
        'div',
        { className: 'senti-poll-sharing-content' },
        React.createElement(
          'div',
          { className: 'senti-poll-quote' },
          '“',
          React.createElement(
            'em',
            null,
            ...
            React.createElement(
              'span',
              { className: 'senti-poll-black-bold' },
              this.state.text
            )
          ),
          '”'
        ...
        React.createElement(
          'div',
          { className: 'senti-poll-share-row' },
          React.createElement(FacebookButton, _extends({ share: this._registerShare, question: this.props.question }, this.state)),
          React.createElement(TwitterButton, { share: this._registerShare, question: this.props.question, answer: this.state.text }),
          React.createElement(GoogleButton, { share: this._registerShare })
        )
      )
    );
  }
...
},{"./sharing/Facebook.jsx":195,"./sharing/Google.jsx":196,"./sharing/Twitter.jsx":197,"react":186}],194:[function(require,module,exports){
/** React.DOM */
'use strict';
...
var App = React.createClass({
  ...
  _checkStoreForVote: function _checkStoreForVote() {
  ...
  _checkVoteValue: function _checkVoteValue() {
    if (store.get(this.props.firebaseId)) {
  ...
  _handleVote: function _handleVote(answerId) {
  ...
  _readableNumbers: function _readableNumbers() {
    return addCommas(this.state.pollData.entries);
  },

  _votesSoFar: function _votesSoFar() {
    if (this.state.pollData.entries > 10) {
      return React.createElement(
        'label',
        { className: 'senti-poll-votes-so-far' },
        this._readableNumbers(),
        ' votes'
      );
    } else {
      return React.createElement('span', null);
  ...
  _renderSubComponents: function _renderSubComponents() {
    if (!this.state.userVoted) {
      return React.createElement(Answers, { key: 'answers', answers: this.state.pollData.answers, handleVote: this._handleVote });
    } else {
      return React.createElement(
        'div',
        null,
        React.createElement(Results, _extends({ key: 'results' }, this.state)),
        React.createElement(Sharing, { firebaseId: this.props.firebaseId, key: 'sharing', question: this.state.pollData.question, answers: this.state.pollData.answers, votedFor: this.state.votedFor })
      );
    }
  },
...
React.render(React.createElement(App, { firebaseId: firebaseId }), sentiBlock);

},{"./Answers.jsx":191,"./Results.jsx":192,"./Sharing.jsx":193,"add-commas":1,"react/addons":14,"reactfire":187,"store":188}],195:[function(require,module,exports){
'use strict';
...
var TwitterButton = React.createClass({
  ...
  _getTwitterHandle: function _getTwitterHandle() {
